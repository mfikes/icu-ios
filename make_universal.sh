...
lipo -create -output "$OUTPUT_PATH/libicule.a" "build-arm64/lib/libicule.a" "build-armv7/lib/libicule.a" "build-armv7s/lib/libicule.a" "build-x86_64/lib/libicule.a"
lipo -create -output "$OUTPUT_PATH/libiculx.a" "build-arm64/lib/libiculx.a" "build-armv7/lib/libiculx.a" "build-armv7s/lib/libiculx.a" "build-x86_64/lib/libiculx.a"
